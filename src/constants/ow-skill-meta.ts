...
/**
 * OW 공식 이름이 8자를 초과하는 스킬의 축약 매핑.
 * 게임 스킬 이름 제약(1~8자)에 맞추기 위한 하드코딩 변환.
 */
...

  {
    ...
    skills: [
      ...
      },
      {
        ...
        gameValues: { type: "attack", mpCost: 10, multiplier: 1.5 },
      },
      {
        name: "자폭",
        category: "ultimate_damage",
        description: "메카를 자폭시켜 광범위 폭발 피해",
        gameValues: { type: "attack", mpCost: 25, multiplier: 2.8 },
      },
    ],
  },
    ...
    skills: [
      {
        ...
        gameValues: { type: "attack", mpCost: 10, multiplier: 1.6 },
      },
      {
        name: "지진 강타",
        category: "cc",
      ...
      },
      {
        ...
        gameValues: { type: "attack", mpCost: 24, multiplier: 2.7 },
      },
    ],
  },

  {
    ...
    skills: [
      ...
      },
      {
        ...
        gameValues: { type: "attack", mpCost: 8, multiplier: 1.4 },
      },
      {
        name: "파일드라이버",
        category: "attack",
...

  {
    ...
    skills: [
      ...
      },
      {
        ...
        gameValues: { type: "attack", mpCost: 8, multiplier: 1.3 },
      },
      {
        name: "원시의 분노",
...

  {
    ...
    skills: [
      ...
      },
      {
        ...
        gameValues: { type: "heal", mpCost: 12, healAmount: 30 },
      },
      {
        name: "고철총",
        category: "attack",
        description: "근거리 고위력 산탄 발사",
        gameValues: { type: "attack", mpCost: 12, multiplier: 1.7 },
      },
      {
        name: "돼재앙",
        category: "ultimate_damage",
    ...
    skills: [
      {
        ...
        gameValues: { type: "attack", mpCost: 9, multiplier: 1.5 },
      },
      {
        name: "터질 듯한 심장",
        category: "self_heal",
        description: "과열 상태에서 체력 회복 (자가 치유)",
        gameValues: { type: "heal", mpCost: 10, healAmount: 20 },
      },
      {
        name: "광전사",
...

  {
    ...
    skills: [
      ...
      },
      {
        ...
        gameValues: { type: "attack", mpCost: 11, multiplier: 1.6 },
      },
      {
        name: "중력자탄",
        category: "ultimate_cc",
...

  {
    ...
    skills: [
      ...
      },
      {
        ...
        gameValues: { type: "attack", mpCost: 9, multiplier: 1.4 },
      },
      {
        name: "소닉 리펄서",
        category: "cc",
...

  {
    ...
    skills: [
      ...
      },
      {
        ...
        gameValues: { type: "attack", mpCost: 26, multiplier: 2.8 },
      },
    ],
  },

  {
    ...
    skills: [
      ...
      },
      {
        ...
        gameValues: { type: "attack", mpCost: 23, multiplier: 2.7 },
      },
    ],
  },

  {
    ...
    skills: [
      ...
      },
      {
        ...
        gameValues: { type: "attack", mpCost: 22, multiplier: 2.6 },
      },
    ],
  },
...

  {
    ...
    skills: [
      ...
      },
      {
        ...
        gameValues: { type: "heal", mpCost: 12, healAmount: 25 },
      },
      {
        name: "눈보라",
        category: "ultimate_cc",
...

  {
    ...
    skills: [
      ...
      },
      {
        ...
        gameValues: { type: "attack", mpCost: 28, multiplier: 3.0 },
      },
    ],
  },
...

  {
    ...
    skills: [
      ...
      },
      {
        ...
        gameValues: { type: "attack", mpCost: 13, multiplier: 1.8 },
      },
      {
        name: "비행",
        category: "movement",
...

  {
    ...
    skills: [
      ...
      },
      {
        ...
        gameValues: { type: "attack", mpCost: 24, multiplier: 2.8 },
      },
    ],
  },
    ...
    skills: [
      {
        ...
        gameValues: { type: "attack", mpCost: 15, multiplier: 2.0 },
      },
      {
        name: "맹독 지뢰",
        category: "cc",
    ...
    skills: [
      {
        ...
        gameValues: { type: "heal", mpCost: 14, healAmount: 30 },
      },
      {
        name: "불사 장치",
        category: "barrier",
...

  {
    ...
    skills: [
      ...
      },
      {
        ...
        gameValues: { type: "heal", mpCost: 28, healAmount: 50 },
      },
    ],
  },
...

  {
    ...
    skills: [
      ...
      },
      {
        ...
        gameValues: { type: "heal", mpCost: 24, healAmount: 45 },
      },
      {
        name: "연꽃 단상",
        category: "barrier",
...
/** OW 메타데이터에서 게임 스킬 프리셋 1개를 생성한다 */
export function generateSkillPreset(hero: OwHeroMeta): HeroSkillPreset {
  return {
    heroId: hero.heroId,
...
/** 전체 영웅의 스킬 프리셋을 자동 생성한다 */
export function generateAllSkillPresets(): HeroSkillPreset[] {
  return OW_HERO_META.map(generateSkillPreset);
}
