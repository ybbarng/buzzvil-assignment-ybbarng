...
export const HERO_PRESETS: HeroPreset[] = [
  // ── 돌격 (14명) ──────────────────────────────
  // 개시자 기본: HP 82, MP 45, ATK 18, DEF 25, SPD 30
  ...
  // 개시자
  {
    ...
    stats: { hp: 85, mp: 42, atk: 16, def: 27, spd: 30 },
  },
  {
    id: "doomfist",
    name: "둠피스트",
    ...
    stats: { hp: 85, mp: 40, atk: 22, def: 23, spd: 30 },
  },
  {
    id: "wrecking-ball",
    name: "레킹볼",
    ...
    stats: { hp: 80, mp: 47, atk: 21, def: 22, spd: 30 },
  },
  {
    id: "winston",
    name: "윈스턴",
    ...
    stats: { hp: 82, mp: 50, atk: 16, def: 22, spd: 30 },
  },

  // 투사 기본: HP 90, MP 42, ATK 20, DEF 28, SPD 20
  ...
  // 투사
  {
    ...
    stats: { hp: 95, mp: 42, atk: 22, def: 26, spd: 15 },
  },
  {
    id: "mauga",
    name: "마우가",
    ...
    stats: { hp: 92, mp: 42, atk: 25, def: 23, spd: 18 },
  },
  {
    id: "orisa",
    name: "오리사",
    ...
    stats: { hp: 92, mp: 42, atk: 18, def: 30, spd: 18 },
  },
  {
    id: "zarya",
    name: "자리야",
    ...
    stats: { hp: 85, mp: 47, atk: 23, def: 25, spd: 20 },
  },

  // 강건한 자 기본: HP 95, MP 40, ATK 15, DEF 30, SPD 20
  ...
  // 강건한 자
  {
    ...
    stats: { hp: 93, mp: 40, atk: 17, def: 30, spd: 20 },
  },
  {
    id: "ramattra",
    name: "라마트라",
    ...
    stats: { hp: 92, mp: 40, atk: 20, def: 28, spd: 20 },
  },
  {
    id: "reinhardt",
    name: "라인하르트",
    ...
    stats: { hp: 98, mp: 37, atk: 17, def: 30, spd: 18 },
  },
  {
    id: "sigma",
    name: "시그마",
    ...
    stats: { hp: 90, mp: 48, atk: 12, def: 30, spd: 20 },
  },
  {
    id: "junker-queen",
    name: "정커퀸",
    ...
    stats: { hp: 90, mp: 40, atk: 20, def: 27, spd: 23 },
  },
  {
    id: "hazard",
    name: "해저드",
    ...
    stats: { hp: 90, mp: 45, atk: 17, def: 28, spd: 20 },
  },

  // ── 공격 (22명) ──────────────────────────────
  // 전문가 기본: HP 55, MP 75, ATK 25, DEF 18, SPD 27
  ...
  // 전문가
  {
    ...
    stats: { hp: 60, mp: 75, atk: 22, def: 23, spd: 20 },
  },
  {
    id: "bastion",
    name: "바스티온",
    ...
    stats: { hp: 55, mp: 75, atk: 30, def: 20, spd: 20 },
  },
  {
    id: "soldier-76",
    name: "솔저: 76",
    ...
    stats: { hp: 60, mp: 72, atk: 25, def: 16, spd: 27 },
  },
  {
    id: "symmetra",
    name: "시메트라",
    ...
    stats: { hp: 55, mp: 80, atk: 22, def: 20, spd: 23 },
  },
  {
    id: "emre",
    name: "엠레",
    ...
    stats: { hp: 52, mp: 75, atk: 28, def: 15, spd: 30 },
  },
  {
    id: "junkrat",
    name: "정크랫",
    ...
    stats: { hp: 58, mp: 75, atk: 30, def: 15, spd: 22 },
  },
  {
    id: "torbjorn",
    name: "토르비욘",
    ...
    stats: { hp: 60, mp: 75, atk: 25, def: 25, spd: 15 },
  },

  // 수색가 기본: HP 58, MP 78, ATK 22, DEF 12, SPD 30
  ...
  // 수색가
  {
    ...
    stats: { hp: 58, mp: 83, atk: 19, def: 10, spd: 30 },
  },
  {
    id: "echo",
    name: "에코",
    ...
    stats: { hp: 53, mp: 80, atk: 25, def: 12, spd: 30 },
  },
  {
    id: "pharah",
    name: "파라",
    ...
    stats: { hp: 56, mp: 75, atk: 27, def: 12, spd: 30 },
  },
  {
    id: "freja",
    name: "프레야",
    ...
    stats: { hp: 60, mp: 75, atk: 20, def: 15, spd: 30 },
  },

  // 측면 공격가 기본: HP 50, MP 82, ATK 28, DEF 10, SPD 30
  ...
  // 측면 공격가
  {
    ...
    stats: { hp: 46, mp: 82, atk: 30, def: 12, spd: 30 },
  },
  {
    id: "reaper",
    name: "리퍼",
    ...
    stats: { hp: 55, mp: 80, atk: 30, def: 10, spd: 25 },
  },
  {
    id: "vendetta",
    name: "벤데타",
    ...
    stats: { hp: 50, mp: 82, atk: 28, def: 10, spd: 30 },
  },
  {
    id: "venture",
    name: "벤처",
    ...
    stats: { hp: 53, mp: 80, atk: 24, def: 13, spd: 30 },
  },
  {
    id: "anran",
    name: "안란",
    ...
    stats: { hp: 48, mp: 82, atk: 30, def: 10, spd: 30 },
  },
  {
    id: "tracer",
    name: "트레이서",
    ...
    stats: { hp: 45, mp: 87, atk: 28, def: 10, spd: 30 },
  },

  // 명사수 기본: HP 50, MP 80, ATK 30, DEF 15, SPD 25
  ...
  // 명사수
  {
    ...
    stats: { hp: 52, mp: 80, atk: 30, def: 17, spd: 21 },
  },
  {
    id: "ashe",
    name: "애쉬",
    ...
    stats: { hp: 55, mp: 80, atk: 30, def: 13, spd: 22 },
  },
  {
    id: "widowmaker",
    name: "위도우메이커",
    ...
    stats: { hp: 45, mp: 85, atk: 30, def: 15, spd: 25 },
  },
  {
    id: "cassidy",
    name: "캐서디",
    ...
    stats: { hp: 55, mp: 75, atk: 30, def: 18, spd: 22 },
  },
  {
    id: "hanzo",
    name: "한조",
    ...
    stats: { hp: 47, mp: 82, atk: 30, def: 13, spd: 28 },
  },

  // ── 지원 (14명) ──────────────────────────────
  // 전술가 기본: HP 50, MP 90, ATK 12, DEF 20, SPD 28
  ...
  // 전술가
  {
    ...
    stats: { hp: 52, mp: 88, atk: 10, def: 20, spd: 30 },
  },
  {
    id: "baptiste",
    name: "바티스트",
    ...
    stats: { hp: 55, mp: 85, atk: 15, def: 20, spd: 25 },
  },
  {
    id: "ana",
    name: "아나",
    ...
    stats: { hp: 50, mp: 90, atk: 17, def: 20, spd: 23 },
  },
  {
    id: "zenyatta",
    name: "젠야타",
    ...
    stats: { hp: 45, mp: 95, atk: 15, def: 17, spd: 28 },
  },
  {
    id: "jetpack-cat",
    name: "제트팩 캣",
    ...
    stats: { hp: 53, mp: 90, atk: 9, def: 22, spd: 26 },
  },

  // 의무관 기본: HP 50, MP 95, ATK 10, DEF 20, SPD 25
  ...
  // 의무관
  {
    ...
    stats: { hp: 50, mp: 98, atk: 7, def: 22, spd: 23 },
  },
  {
    id: "mercy",
    name: "메르시",
    ...
    stats: { hp: 53, mp: 97, atk: 5, def: 18, spd: 27 },
  },
  {
    id: "moira",
    name: "모이라",
    ...
    stats: { hp: 55, mp: 87, atk: 15, def: 18, spd: 25 },
  },
  {
    id: "kiriko",
    name: "키리코",
    ...
    stats: { hp: 45, mp: 90, atk: 15, def: 20, spd: 30 },
  },

  // 생존왕 기본: HP 60, MP 80, ATK 15, DEF 22, SPD 23
  ...
  // 생존왕
  {
    ...
    stats: { hp: 60, mp: 83, atk: 12, def: 22, spd: 23 },
  },
  {
    id: "brigitte",
    name: "브리기테",
    ...
    stats: { hp: 68, mp: 70, atk: 18, def: 27, spd: 17 },
  },
  {
    id: "illari",
    name: "일리아리",
    ...
    stats: { hp: 57, mp: 82, atk: 18, def: 22, spd: 21 },
  },
  {
    id: "wuyang",
    name: "우양",
    ...
    stats: { hp: 62, mp: 80, atk: 12, def: 25, spd: 21 },
  },
  {
    id: "juno",
    name: "주노",
    ...
    stats: { hp: 55, mp: 82, atk: 15, def: 20, spd: 28 },
  },
];
