...
/**
 * 스킬별 게임 수치.
 * SkillPresetEntry(= Skill − isDefault)에서 defend를 제외하고 name을 뺀 타입.
 * Skill 타입이 변경되면 자동으로 반영된다.
 */
export type SkillGameValues = DistributiveOmit<
  Exclude<SkillPresetEntry, { type: "defend" }>,
  "name"
>;
